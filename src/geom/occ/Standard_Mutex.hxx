...
#include <mobius/NCollection_Shared.hxx>
...
public:
  ...
  mobiusGeom_EXPORT Standard_Mutex ();
  ...
  mobiusGeom_EXPORT bool TryLock ();
...
private:
  ...
  mobiusGeom_EXPORT virtual void DestroyCallback() Standard_OVERRIDE;
