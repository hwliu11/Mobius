...
public:
  ...
  mobiusGeom_EXPORT void Coefficients (Standard_Real& A1,
                                       Standard_Real& A2, 
                                       Standard_Real& A3, 
                                       Standard_Real& B1, 
                                       Standard_Real& B2,
  ...
  //! symmetry.
  mobiusGeom_EXPORT Standard_NODISCARD gp_Cylinder Mirrored (const gp_Pnt& P) const;
  ...
  //! symmetry.
  mobiusGeom_EXPORT Standard_NODISCARD gp_Cylinder Mirrored (const gp_Ax1& A1) const;
  ...
  mobiusGeom_EXPORT Standard_NODISCARD gp_Cylinder Mirrored (const gp_Ax2& A2) const;
