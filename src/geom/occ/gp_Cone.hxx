...
public:
  ...
  mobiusGeom_EXPORT void Coefficients (Standard_Real& A1, Standard_Real& A2, Standard_Real& A3, Standard_Real& B1, Standard_Real& B2, Standard_Real& B3, Standard_Real& C1, Standard_Real& C2, Standard_Real& C3, Standard_Real& D) const;
  ...
  //! symmetry.
  Standard_NODISCARD mobiusGeom_EXPORT gp_Cone Mirrored (const gp_Pnt& P) const;
  ...
  //! symmetry.
  Standard_NODISCARD mobiusGeom_EXPORT gp_Cone Mirrored (const gp_Ax1& A1) const;
  ...
  Standard_NODISCARD mobiusGeom_EXPORT gp_Cone Mirrored (const gp_Ax2& A2) const;
