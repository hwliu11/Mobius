...
#include <mobius/Standard_Address.hxx>
...
public:
  ...
  mobiusGeom_EXPORT static Standard_Address Allocate (const Standard_Size aSize);
  
  //! Deallocates memory blocks
  //! @param thePtr - previously allocated memory block to be freed
  mobiusGeom_EXPORT static void Free (const Standard_Address thePtr);
  ...
  mobiusGeom_EXPORT static Standard_Address Reallocate (const Standard_Address aStorage, const Standard_Size aNewSize);
  ...
  mobiusGeom_EXPORT static Standard_Address AllocateAligned (const Standard_Size theSize, const Standard_Size theAlign);
  
  //! Deallocates memory blocks
  //! @param thePtrAligned the memory block previously allocated with AllocateAligned()
  mobiusGeom_EXPORT static void FreeAligned (const Standard_Address thePtrAligned);
  ...
  mobiusGeom_EXPORT static int Purge();
  ...
  mobiusGeom_EXPORT static Standard_Boolean StackTrace (char* theBuffer,
