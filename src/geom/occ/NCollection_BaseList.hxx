...
public:
 ...
 protected:
  ...
  mobiusGeom_EXPORT void PClear (NCollection_DelListNode fDel);
  ...
  mobiusGeom_EXPORT void PAppend (NCollection_ListNode* theNode);
  ...
  mobiusGeom_EXPORT void PAppend (NCollection_BaseList& theOther);

  // ******** PPrepend
  // Purpose: Prepends theNode at the beginning
  mobiusGeom_EXPORT void PPrepend (NCollection_ListNode* theNode);

  // ******** PPrepend
  // Purpose: Prepends theOther list at the beginning (clearing it)
  mobiusGeom_EXPORT void PPrepend (NCollection_BaseList& theOther);

  // ******** PRemoveFirst
  // Purpose: Removes first node
  mobiusGeom_EXPORT void PRemoveFirst 
    (NCollection_DelListNode fDel);

  // ******** PRemove
  // Purpose: Removes the node pointed by theIter[ator]
  mobiusGeom_EXPORT void PRemove 
    (Iterator& theIter,
     NCollection_DelListNode fDel);

  // ******** PInsertBefore
  // Purpose: Inserts theNode before one pointed by theIter[ator]
  mobiusGeom_EXPORT void PInsertBefore (NCollection_ListNode* theNode,
                                      Iterator& theIter);

  // ******** PInsertBefore
  // Purpose: Inserts theOther list before the node pointed by theIter[ator]
  mobiusGeom_EXPORT void PInsertBefore (NCollection_BaseList& theOther,
                                      Iterator& theIter);

  // ******** PInsertAfter
  // Purpose: Inserts theNode after one pointed by theIter[ator]
  mobiusGeom_EXPORT void PInsertAfter (NCollection_ListNode* theNode,
                                     Iterator& theIter);

  // ******** PInsertAfter
  // Purpose: Inserts theOther list after the node pointed by theIter[ator]
  mobiusGeom_EXPORT void PInsertAfter (NCollection_BaseList& theOther,
                                     Iterator& theIter);
