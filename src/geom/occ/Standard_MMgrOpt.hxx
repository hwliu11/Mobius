...
class Standard_MMgrOpt : public Standard_MMgrRoot
{
 public:
  ...
  //! of the class above.
  mobiusGeom_EXPORT Standard_MMgrOpt
  ...
  mobiusGeom_EXPORT virtual ~Standard_MMgrOpt();
  
  //! Allocate aSize bytes; see class description above
  mobiusGeom_EXPORT virtual Standard_Address Allocate(const Standard_Size aSize);
  ...
  mobiusGeom_EXPORT virtual Standard_Address Reallocate (Standard_Address thePtr, 
                                                       const Standard_Size theSize);
  
  //! Free previously allocated block.
  //! Note that block can not all blocks are released to the OS by this 
  //! method (see class description)
  mobiusGeom_EXPORT virtual void Free (Standard_Address thePtr);
  
  //! Release medium-sized blocks of memory in free lists to the system.
  //! Returns number of actually freed blocks
  mobiusGeom_EXPORT virtual Standard_Integer Purge(Standard_Boolean isDestroyed);
  ...
  mobiusGeom_EXPORT static void SetCallBackFunction(TPCallBackFunc pFunc);

protected:
 
  //! Internal - initialization of buffers
  mobiusGeom_EXPORT void Initialize();
