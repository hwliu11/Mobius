...
public:
  ...
  mobiusGeom_EXPORT bool IsCoaxial (const gp_Ax2d& Other, const double AngularTolerance, const double LinearTolerance) const;
  ...
  mobiusCore_NODISCARD gp_Ax2d Reversed() const
  { 
    gp_Ax2d aTemp = *this;
    aTemp.Reverse();
    return aTemp;
  ...
  mobiusGeom_EXPORT void Mirror (const gp_Pnt2d& P);

  //! Performs the symmetrical transformation of an axis
  //! placement with respect to the point P which is the
  //! center of the symmetry.
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Ax2d Mirrored (const gp_Pnt2d& P) const;

  mobiusGeom_EXPORT void Mirror (const gp_Ax2d& A);

  //! Performs the symmetrical transformation of an axis
  //! placement with respect to an axis placement which
  //! is the axis of the symmetry.
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Ax2d Mirrored (const gp_Ax2d& A) const;
  ...
  mobiusCore_NODISCARD gp_Ax2d Rotated (const gp_Pnt2d& theP, const double theAng) const
  {
    gp_Ax2d anA = *this;
  ...
  mobiusGeom_EXPORT void Scale (const gp_Pnt2d& P, const double S);

  //! Applies a scaling transformation on the axis placement.
  //! The "Location" point of the axisplacement is modified.
  //! The "Direction" is reversed if the scale is negative.
  mobiusCore_NODISCARD gp_Ax2d Scaled (const gp_Pnt2d& theP, const double theS) const
  {
    gp_Ax2d anA = *this;
    anA.Scale (theP, theS);
    return anA;
  ...
  mobiusCore_NODISCARD gp_Ax2d Transformed (const gp_Trsf2d& theT) const
  {
    gp_Ax2d anA = *this;
    anA.Transform (theT);
    return anA;
  ...
  mobiusCore_NODISCARD gp_Ax2d Translated (const gp_Vec2d& theV) const
  {
    gp_Ax2d anA = *this;
