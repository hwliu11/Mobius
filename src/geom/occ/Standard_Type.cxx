...
bool Standard_Type::SubType (const Handle(Standard_Type)& theOther) const
{
...
bool Standard_Type::SubType (const Standard_CString theName) const
{
...
// ------------------------------------------------------------------
void Standard_Type::Print (std::ostream& AStream) const
{
