...
public:
  ...
  //! symmetry.
  Standard_NODISCARD mobiusGeom_EXPORT gp_Torus Mirrored (const gp_Pnt& P) const;
  ...
  //! symmetry.
  Standard_NODISCARD mobiusGeom_EXPORT gp_Torus Mirrored (const gp_Ax1& A1) const;
  ...
  Standard_NODISCARD mobiusGeom_EXPORT gp_Torus Mirrored (const gp_Ax2& A2) const;
