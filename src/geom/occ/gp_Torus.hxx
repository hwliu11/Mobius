...
public:
  ...
  //! symmetry.
  mobiusGeom_EXPORT Standard_NODISCARD gp_Torus Mirrored (const gp_Pnt& P) const;
  ...
  //! symmetry.
  mobiusGeom_EXPORT Standard_NODISCARD gp_Torus Mirrored (const gp_Ax1& A1) const;
  ...
  mobiusGeom_EXPORT Standard_NODISCARD gp_Torus Mirrored (const gp_Ax2& A2) const;
