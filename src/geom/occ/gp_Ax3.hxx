...
public:
  ...
  mobiusGeom_EXPORT gp_Ax3 (const gp_Pnt& theP, const gp_Dir& theV);
  ...
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Ax3 Mirrored (const gp_Pnt& theP) const;
  ...
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Ax3 Mirrored (const gp_Ax1& theA1) const;
  ...
  //! The resulting main "Direction" is the cross product between
  //! the "XDirection" and the "YDirection" after transformation.
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Ax3 Mirrored (const gp_Ax2& theA2) const;
  ...
  //! in radians.
  mobiusCore_NODISCARD gp_Ax3 Rotated (const gp_Ax1& theA1, const double theAng) const
  {
    gp_Ax3 aTemp = *this;
  ...
  //! . The "XDirection" and the "YDirection" are reversed.
  //! So the axis placement stay right handed.
  mobiusCore_NODISCARD gp_Ax3 Scaled (const gp_Pnt& theP, const double theS) const
  {
    gp_Ax3 aTemp = *this;
  ...
  //! the "XDirection" and the "YDirection" after transformation.
  mobiusCore_NODISCARD gp_Ax3 Transformed (const gp_Trsf& theT) const
  {
    gp_Ax3 aTemp = *this;
  ...
  mobiusCore_NODISCARD gp_Ax3 Translated (const gp_Vec& theV) const
  {
    gp_Ax3 aTemp = *this;
  ...
  //! point <theP2>.
  mobiusCore_NODISCARD gp_Ax3 Translated (const gp_Pnt& theP1, const gp_Pnt& theP2) const { return Translated (gp_Vec (theP1, theP2)); }
