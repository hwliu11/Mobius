...
#include <mobius/NCollection_IncAllocator.hxx>
#include <mobius/NCollection_DataMap.hxx>
#include <mobius/NCollection_Map.hxx>
 ...
 */
//=======================================================================
mobiusGeom_EXPORT Standard_Size& StandardCallBack_CatchSize()
{
 ...
 */
//=======================================================================
mobiusGeom_EXPORT Standard_Size& StandardCallBack_CatchID()
{
  static Standard_Size Value = 0;
  return Value;
}
 ...
 */
//=======================================================================
mobiusGeom_EXPORT void StandardCallBack_Reset()
{
  StorageMap().Clear();
  StorageIDMap().Clear();
  StorageIDSet().Clear();
