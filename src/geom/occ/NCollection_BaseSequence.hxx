...
public:
  ...
  public:
    ...
    void Init (const NCollection_BaseSequence& theSeq,
               const bool isStart = Standard_True)
    {
 ...
 protected:
  ...
  mobiusGeom_EXPORT void   ClearSeq    (NCollection_DelSeqNode fDel);
  mobiusGeom_EXPORT void   PAppend     (NCollection_SeqNode *);
  mobiusGeom_EXPORT void   PAppend     (NCollection_BaseSequence& S);
  mobiusGeom_EXPORT void   PPrepend    (NCollection_SeqNode *);
  mobiusGeom_EXPORT void   PPrepend    (NCollection_BaseSequence& S);
  mobiusGeom_EXPORT void   PInsertAfter(Iterator& thePosition,
                                      NCollection_SeqNode *);
  mobiusGeom_EXPORT void   PInsertAfter(const int Index,
                                      NCollection_SeqNode *);
  mobiusGeom_EXPORT void   PInsertAfter(const int Index,
                                      NCollection_BaseSequence& S);
  mobiusGeom_EXPORT void   PSplit      (const int Index,
                                      NCollection_BaseSequence& Sub);
  mobiusGeom_EXPORT void   RemoveSeq   (Iterator& thePosition,
                                      NCollection_DelSeqNode fDel);
  mobiusGeom_EXPORT void   RemoveSeq   (const int Index,
                                      NCollection_DelSeqNode fDel);
  mobiusGeom_EXPORT void   RemoveSeq   (const int From,
                                      const int To,
                                      NCollection_DelSeqNode fDel);
  mobiusGeom_EXPORT void   PReverse    ();
  mobiusGeom_EXPORT void   PExchange   (const int I,
                                      const int J) ;
  mobiusGeom_EXPORT NCollection_SeqNode *
                         Find        (const int) const;
 ...
 private: 
  // Methods PRIVATE
  // 
  mobiusGeom_EXPORT NCollection_BaseSequence
