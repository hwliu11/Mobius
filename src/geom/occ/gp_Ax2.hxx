...
public:
  ...
  mobiusGeom_EXPORT gp_Ax2(const gp_Pnt& P, const gp_Dir& V);
  ...
  //! This maintains the right-handed property of the
  //! coordinate system.
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Ax2 Mirrored (const gp_Pnt& P) const;
  ...
  //! This maintains the right-handed property of the
  //! coordinate system.
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Ax2 Mirrored (const gp_Ax1& A1) const;
  ...
  //! This maintains the right-handed property of the
  //! coordinate system.
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Ax2 Mirrored (const gp_Ax2& A2) const;
  ...
  mobiusCore_NODISCARD gp_Ax2 Rotated (const gp_Ax1& theA1, const double theAng) const
  {
    gp_Ax2 aTemp = *this;
    aTemp.Rotate (theA1, theAng);
    return aTemp;
  ...
  mobiusCore_NODISCARD gp_Ax2 Scaled (const gp_Pnt& theP, const double theS) const
  {
    gp_Ax2 aTemp = *this;
    aTemp.Scale (theP, theS);
    return aTemp;
  ...
  mobiusCore_NODISCARD gp_Ax2 Transformed (const gp_Trsf& theT) const
  {
    gp_Ax2 aTemp = *this;
    aTemp.Transform (theT);
    return aTemp;
  ...
  mobiusCore_NODISCARD gp_Ax2 Translated (const gp_Vec& theV) const
  {
    gp_Ax2 aTemp = *this;
  ...
  mobiusCore_NODISCARD gp_Ax2 Translated (const gp_Pnt& theP1, const gp_Pnt& theP2) const
  {
    gp_Ax2 aTemp = *this;
