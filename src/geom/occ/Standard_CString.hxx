...
mobiusGeom_EXPORT Standard_Integer HashCode (Standard_CString theString, Standard_Integer theUpperBound);
...
mobiusGeom_EXPORT Standard_Integer HashCodes (Standard_CString theString, Standard_Integer theLength);
...
mobiusGeom_EXPORT double Atof (const char* theStr);

//! Optimized equivalent of standard C function strtod() that always uses C locale
mobiusGeom_EXPORT double Strtod (const char* theStr, char** theNextPtr);

//! Equivalent of standard C function printf() that always uses C locale
mobiusGeom_EXPORT int Printf (const char* theFormat, ...);

//! Equivalent of standard C function fprintf() that always uses C locale
mobiusGeom_EXPORT int Fprintf (FILE* theFile, const char* theFormat, ...);

//! Equivalent of standard C function sprintf() that always uses C locale
mobiusGeom_EXPORT int Sprintf (char* theBuffer, const char* theFormat, ...);
...
mobiusGeom_EXPORT int Vsprintf (char* theBuffer, const char* theFormat, va_list theArgList);
