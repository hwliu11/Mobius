...
class Standard_MMgrRoot
{
 public:
  ...
  mobiusGeom_EXPORT virtual ~Standard_MMgrRoot();
  ...
  mobiusGeom_EXPORT virtual Standard_Address Allocate (const Standard_Size theSize)=0;
  ...
  mobiusGeom_EXPORT virtual void Free(Standard_Address thePtr)=0;
