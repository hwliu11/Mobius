...
public:
  ...
  mobiusGeom_EXPORT void InfoFirst (Intf_PIType& Dim, int& Add1, int& Add2, double& Param) const;
  
  //! Gives the   datas  about   the    first  argument of    the
  //! Interference.
  mobiusGeom_EXPORT void InfoFirst (Intf_PIType& Dim, int& Addr, double& Param) const;
  
  mobiusGeom_EXPORT void InfoSecond (Intf_PIType& Dim, int& Add1, int& Add2, double& Param) const;
  
  //! Gives the   datas  about   the    second  argument of    the
  //! Interference.
  mobiusGeom_EXPORT void InfoSecond (Intf_PIType& Dim, int& Addr, double& Param) const;
  ...
  mobiusGeom_EXPORT double Incidence() const;
  ...
  bool operator== (const Intf_SectionPoint& Other) const
{
  ...
  mobiusGeom_EXPORT bool IsOnSameEdge (const Intf_SectionPoint& Other) const;
  
  mobiusGeom_EXPORT Intf_SectionPoint();
  ...
  mobiusGeom_EXPORT Intf_SectionPoint(const gp_Pnt& Where, const Intf_PIType DimeO, const int AddrO1, const int AddrO2, const double ParamO, const Intf_PIType DimeT, const int AddrT1, const int AddrT2, const double ParamT, const double Incid);
  
  //! Builds  a  SectionPoint 2d   with the respective dimensions
  //! (vertex or  edge)  of  the concerned arguments   and  their
  //! addresses in the Topological structure.
  mobiusGeom_EXPORT Intf_SectionPoint(const gp_Pnt2d& Where, const Intf_PIType DimeO, const int AddrO1, const double ParamO, const Intf_PIType DimeT, const int AddrT1, const double ParamT, const double Incid);
  
  //! Merges two SectionPoints.
  mobiusGeom_EXPORT void Merge (Intf_SectionPoint& Other);
