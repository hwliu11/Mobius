...
public:
  ...
  mobiusGeom_EXPORT bool IsCoaxial (const gp_Ax1& Other, const double AngularTolerance, const double LinearTolerance) const;
  ...
  mobiusCore_NODISCARD gp_Ax1 Reversed() const
  {
  ...
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Ax1 Mirrored (const gp_Pnt& P) const;
  ...
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Ax1 Mirrored (const gp_Ax1& A1) const;
  ...
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Ax1 Mirrored (const gp_Ax2& A2) const;
  ...
  mobiusCore_NODISCARD gp_Ax1 Rotated (const gp_Ax1& theA1, const double theAngRad) const
  {
    gp_Ax1 A = *this;
  ...
  mobiusCore_NODISCARD gp_Ax1 Scaled (const gp_Pnt& theP, const double theS) const
  {
    gp_Ax1 A1 = *this;
    A1.Scale (theP, theS);
    return A1;
  ...
  mobiusCore_NODISCARD gp_Ax1 Transformed (const gp_Trsf& theT) const
  {
    gp_Ax1 A1 = *this;
    A1.Transform (theT);
    return A1;
  ...
  //! and creates a new one.
  mobiusCore_NODISCARD gp_Ax1 Translated (const gp_Vec& theV) const
  {
    gp_Ax1 A1 = *this;
  ...
  //! the vector (theP1, theP2) defined from point theP1 to point theP2.
  //! and creates a new one.
  mobiusCore_NODISCARD gp_Ax1 Translated (const gp_Pnt& theP1, const gp_Pnt& theP2) const
  {
    gp_Ax1 A1 = *this;
