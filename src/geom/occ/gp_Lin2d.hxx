...
public:
  ...
  mobiusGeom_EXPORT gp_Lin2d (const double theA, const double theB, const double theC);
  ...
  mobiusCore_NODISCARD gp_Lin2d Reversed() const
  {
    gp_Lin2d aL = *this;
    aL.pos.Reverse();
    return aL;
  ...
  void Coefficients (double& theA, double& theB, double& theC) const
  {
  ...
  bool Contains (const gp_Pnt2d& theP, const double theLinearTolerance) const
  {
    return Distance (theP) <= theLinearTolerance;
  }

  //! Computes the distance between <me> and the point <theP>.
  double Distance (const gp_Pnt2d& theP) const;

  //! Computes the distance between two lines.
  double Distance (const gp_Lin2d& theOther) const;

  //! Computes the square distance between <me> and the point
  //! <theP>.
  double SquareDistance (const gp_Pnt2d& theP) const;

  //! Computes the square distance between two lines.
  double SquareDistance (const gp_Lin2d& theOther) const;
  ...
  //! of the symmetry
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Lin2d Mirrored (const gp_Pnt2d& theP) const;
  ...
  //! of the symmetry.
  mobiusCore_NODISCARD mobiusGeom_EXPORT gp_Lin2d Mirrored (const gp_Ax2d& theA) const;
  ...
  mobiusCore_NODISCARD gp_Lin2d Rotated (const gp_Pnt2d& theP, const double theAng) const
  {
    gp_Lin2d aL = *this;
  ...
  mobiusCore_NODISCARD gp_Lin2d Scaled (const gp_Pnt2d& theP, const double theS) const
  {
    gp_Lin2d aL = *this;
  ...
  mobiusCore_NODISCARD gp_Lin2d Transformed (const gp_Trsf2d& theT) const
  {
    gp_Lin2d aL = *this;
  ...
  mobiusCore_NODISCARD gp_Lin2d Translated (const gp_Vec2d& theV) const
  {
    gp_Lin2d aL = *this;
...
// purpose :
//=======================================================================
inline double gp_Lin2d::Distance (const gp_Pnt2d& theP) const
{
...
// purpose :
//=======================================================================
inline double gp_Lin2d::Distance (const gp_Lin2d& theOther) const
{
  double aD = 0.0;
...
// purpose :
//=======================================================================
inline double gp_Lin2d::SquareDistance (const gp_Pnt2d& theP) const
{
  gp_XY aCoord = theP.XY();
  aCoord.Subtract ((pos.Location()).XY());
...
// purpose :
//=======================================================================
inline double gp_Lin2d::SquareDistance (const gp_Lin2d& theOther) const
{
  double aD = 0.0;
  if (pos.IsParallel (theOther.pos, gp::Resolution()))
  {
