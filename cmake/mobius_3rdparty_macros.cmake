...
# Include functions
include (${CMAKE_SOURCE_DIR}/cmake/mobius_functions.cmake)

#-------------------------------------------------------------------------------
# Name:    MOBIUS_CHECK_PATH_FOR_CONSISTENCY
# Purpose: checks path on consistency
#-------------------------------------------------------------------------------
macro (MOBIUS_CHECK_PATH_FOR_CONSISTENCY
       THE_ROOT_PATH_NAME
...
#-------------------------------------------------------------------------------
# Name:    MOBIUS_THIRDPARTY_PRODUCT
# Purpose: handles a single 3-rd party product
#-------------------------------------------------------------------------------
macro (MOBIUS_THIRDPARTY_PRODUCT
       PRODUCT_NAME
       SUBINC_NAME
       HEADER_NAME
       LIBRARY_NAME)
  ...
  MOBIUS_MAKE_PLATFORM_SHORT_NAME ()
  ...
  if (3RDPARTY_DIR AND EXISTS "${3RDPARTY_DIR}")
    if (NOT 3RDPARTY_${PRODUCT_NAME}_DIR OR NOT EXISTS "${3RDPARTY_${PRODUCT_NAME}_DIR}")
      MOBIUS_FIND_PRODUCT_DIR ("${3RDPARTY_DIR}" ${PRODUCT_NAME} ${PRODUCT_NAME}_DIR_NAME)
